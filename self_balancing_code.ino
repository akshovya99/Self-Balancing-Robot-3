...
///////////////////////Kalman_Filter////////////////////////////
float Q_angle = 0.0003;    // smoother angle
float Q_gyro  = 0.002;     // reduce gyro influence
float R_angle = 3.0;       // trust accelerometer more
...
//////////////////////PID parameter///////////////////////////////
double kp = 15, ki =4 , kd = 0.2;                   //angle loop parameter
double kp_speed = 2.0, ki_speed = 0.03, kd_speed = 0;   // speed loop parameter
